...
//abstract class: this class is not able to create an instance of this class, containing at least one abstract method.
//Comparable<Player>: Players implement the Comparable interface with the proper type parameter.
public abstract class Player implements Comparable<Player> {
    ...
    public Player(String name, int susLevel) {
        ...
        if (players == null) {
            ...
            Player[] temp = players;
            //The length of original array can not be changed.
            //Therefore, it needs to create a new one.
